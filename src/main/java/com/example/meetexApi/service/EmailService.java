...
public class EmailService {
    ...
    public void sendVerificationEmail(User user, String verificationLink) throws MessagingException, IOException {
        MimeMessage email = createEmail(user.getEmail(), "cyboranf@gmail.com", "Meetex - Email verification.", "Please click the following link to verify your email: " + verificationLink);
        sendMessage(email);
    }
